...
class MenusController extends Controller {
    ...
    public function actionInstallMenu() {
        ...
        $ary[] = array("id" => "1", "pid" => "0", "root_parent" => "1", "controller" => "site", "action" => "index", "default_title" => "Dtech Systems", "user_title" => "Dtech Systems", "is_assigned" => "Yes", "min_permission" => "View", "weight" => "1");


        $ary[] = array("id" => "2", "pid" => "0", "root_parent" => "2", "controller" => "contactFeedback", "action" => "index", "default_title" => "Contact Feedback", "user_title" => "Contact Feedback", "is_assigned" => "Yes", "min_permission" => "View", "weight" => "2");
